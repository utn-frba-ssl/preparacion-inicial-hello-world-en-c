...
+
image::GitHubProfileAddEmailAddresses.png[width=100%]
...
+
image::GitHubProfilePublicEmail.png[width=100%]

..  Verifique que su cuenta puede encontrarse a partir del mail institucional. Para ello abra una ventana privada/de incógnito en su navegador. Vaya a https://github.com/ y arriba a la derecha, donde tiene para buscar ingrese su email institucional. Compruebe que encuentres un usuario y que este sea el suyo.
+
image::GithubSearch.png[width=100%]
+
image::GithubSearchResult.png[width=100%]

+
Si no fuciona:
... Verifique haber seguido correctamente los pasos.
... En settings → email verifique que la opción “Keep my email addresses private” esté deschequeada
...
.. Informe el número de equipo junto a otros datos como el usuario de github y enlace al repositorio del TP0 en el siguiente
https://script.google.com/a/macros/frba.utn.edu.ar/s/AKfycbzGxEiscdBSbGzcO0ZxnYODicIDSjeAkcfX7DqSc9J8zIX05RuNgF_hmHvv33Q-TwUFwQ/exec[formulario].
+
